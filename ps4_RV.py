...
#Start Problem 1
    ...
    ##    #insert lower and upper case + spacea
    ...
    ##    print alphabet
    ##
    ##    #preapre coder (numbered list)... this may not be needed
    ##    coder=range(len(alphabet))
    ##    print coder
    ##
    ##    #attempt to convert letter to coder
    ##    letter=raw_input("enter letter to be incoded: ")
    ##
    ##    print letter
    ##    codex=[alphabet].index(letter)
    ##    print codex
...
def decode(text, coder):

    text_1 = text
    coder_1 = 27 - coder
    apply_coder(text_1, coder_1)
    print encoded_test
